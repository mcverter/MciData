...
from src.lines.regexes import borough_re, zip_re, docket_no_re, status_re, date_re, close_code_re, \
    possible_mci_per_room_re, work_item_re, cost_re, optional_cost_re, array_to_regex_or
...
docket_line_regex = re.compile(docket_no_re + " " + status_re  +
...
county_date_header = re.compile("FOR " + county_re + " COUNTY FROM " + date_re + " TO " + date_re)
column_header_1 = re.compile("BLDG ADDRESS DOCKET NO CASE STATUS CLOSING DATE CLOSE CODE MONTHLY MCI INCR PER ROOM")
